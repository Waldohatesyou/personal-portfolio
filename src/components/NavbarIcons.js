...
function NavbarIcons() {
  return (
    <div className="flex py-6 px-8 md:px-14 lg:px-24 w-full justify-between fixed">
      <Link
        to="/"
        className="shrink-0 pr-16 font-bold text-xl bg-clip-text text-transparent bg-gradient-to-r from-theme to-secondary"
      >
        Yusuf.nissar
      </Link>
